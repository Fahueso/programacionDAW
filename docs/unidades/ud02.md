...
## 1 Programación Estructurada: Las reglas de tráfico del código
...
## 2 El Algoritmo: El plano de nuestra construcción
...
### 3.4 Estructuras Alternativas (Condicionales)
...
#### 3.4.2 Condicional `if-else` (Doble)
...
#### 3.4.3 Condicional `if else-if else` (Anidada)
...
#### 3.4.4 Condicional `switch` (Múltiple)
...
### 3.5 Estructuras Repetitivas (Bucles)
...
#### 3.5.2 Bucle `do-while` (Hacer-Mientras)
...
## 4 Elementos Auxiliares: Herramientas dentro de los bucles
...
### 5.3 Lectura y Escritura de Matrices
