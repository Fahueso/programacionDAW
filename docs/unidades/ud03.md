...
!!! abstract "Objetivos de la Unidad"
    ...
    - Distinguir entre funciones (con valor de retorno) y procedimientos (`void`).
    - Aplicar el concepto de ámbito de variables (*scope*) y paso de parámetros por valor y por referencia.
...
## 1 Programación Modular: Construyendo con piezas de LEGO
...
## 2. ¿Por qué necesitamos Funciones en Java?
...
!!! success "Ventajas principales de usar funciones"
...
## 3. Anatomía de una Función: La Etiqueta de la Herramienta
...
## 4. Funciones vs. Procedimientos: ¿Devuelves algo o solo actúas?

En nuestra caja de herramientas, tenemos dos tipos de especialistas:

### 4.1. Funciones (Las que devuelven un resultado)
...
### 4.2. Procedimientos (Los que solo realizan una acción)
...
## 5. Ámbito de las Variables: La Regla de la Habitación de Hotel
...
## 6. Paso de Parámetros: Fotocopias vs. Direcciones
...
### 6.1. Paso por Valor: "Te paso una fotocopia" (Tipos Primitivos)
...
### 6.2. Paso por Referencia: "Te paso la dirección" (Arrays y Objetos)
...
### 6.3. Llamada de Funciones desde otras Funciones (Composición)
...
## 7. Buenas Prácticas al Crear Funciones

!!! tip "Reglas de Oro del Diseño de Funciones"
...
## 8. Ejemplo Práctico: Mini-Gestor de Calificaciones
